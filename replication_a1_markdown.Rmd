...
```{r}
source("replication_a1_summary-stats.R", local = knitr::knit_global())
```

```{r}
source("replication_a1_summary-stats_figures.R", local = knitr::knit_global())
```

The results of these scripts can been seen by checking the folders 'table' and 'figures' on the github repository.
